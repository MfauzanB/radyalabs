...
WebUI.click(findTestObject('Object Repository/p_Cabang'))

WebUI.click(findTestObject('Object Repository/button_Tambah Cabang'))

WebUI.setText(findTestObject('Object Repository/input_Kode Cabang_ant-input ng-tns-c126-43 _290086'), '[Test] Cabang 2')

WebUI.setText(findTestObject('Object Repository/input_Nama Cabang_ant-input ng-tns-c126-44 _ca0cdd'), '[Test] Cabang 2')

WebUI.setText(findTestObject('Object Repository/input_Penanggung Jawab_ant-input ng-tns-c12_fba1ea'), 'Fauzan')

WebUI.setText(findTestObject('Object Repository/input_Email Penanggung Jawab_ant-input ng-t_7f7d35'), 'fauzan@fauzan.id')
