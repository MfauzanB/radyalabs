...
WebUI.setText(findTestObject('Object Repository/input_LOGISTIC OPERATION PORTAL_ant-input n_bd3f7e'), 'qwerty@12')

WebUI.click(findTestObject('Object Repository/button_MASUK'))

WebUI.click(findTestObject('Object Repository/span_Anda tidak dapat login'))
